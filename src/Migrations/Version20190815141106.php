 ...
 */
final class Version20190815141106 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, media_id INT NOT NULL, users_id INT NOT NULL, title VARCHAR(50) NOT NULL, review LONGTEXT NOT NULL, date DATETIME NOT NULL, rating VARCHAR(255) NOT NULL, INDEX IDX_794381C6EA9FDD75 (media_id), INDEX IDX_794381C667B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
