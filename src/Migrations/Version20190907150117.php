 ...
 */
final class Version20190907150117 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media_users CHANGE media_id media_id INT DEFAULT NULL, CHANGE users_id users_id INT DEFAULT NULL, CHANGE rating rating INT DEFAULT NULL');
